content = {
  ...
  'The_Sun_Is_A_Mass_Of_Incandescent_Gas': [
  ...
  'Matt_Speech_2025': [
    "Matt's 2025 speech at Montreal's solstice",
    "By Matt",
    "[speech]",
  ],
  ...
  'Origin_of_Stories_Twilight_Edition': [
    "Origin of Stories, Twilight Edition",
  ...
  'What_Exactly_Are_We_Doing_Here': [
  ...
  'Why_Solstice_Why_Failed_Experiments': [
  ...
  'Winter_Is_No_Longer_A_Real_Threat': [
    "Winter Is No Longer A Real Threat",
    "By Matt Elder",
    "[speech]",
  ],
  ...
  'X_Days_of_X_Risk_Intro': [
    "X Days of X-Risk Intro",
    "By Raymond Arnold",
    "[speech]",
  ],
...
recordings = {
  ...
  'We_Are_The_Light': 'We_Are_The_Light_DC_Solstice_2023.mp3',
